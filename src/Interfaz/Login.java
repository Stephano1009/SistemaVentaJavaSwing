...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        TextPrompt placeHolders1 = new TextPrompt("Usuario", txtUsuario);
        TextPrompt placeHolders2 = new TextPrompt("Password", pswPassword);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SISTEMA DE VENTAS COMERCIAL - ROQUE ");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/imagen Login.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Georgia", 1, 12)); // NOI18N
        jLabel4.setText("USUARIO");

        jLabel6.setFont(new java.awt.Font("Georgia", 1, 12)); // NOI18N
        jLabel6.setText("PASSWOORD");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnIngresar, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (!usuario.isEmpty() && password.length != 0) {
            Usuario usu = dao.login(usuario, contraString);
            if (usu != null) {
                JOptionPane.showMessageDialog(null, "Inicio de sesión exitoso");
                Plataforma plataforma = new Plataforma();
                plataforma.getNombreusuario(usu.getNombreCargo(),usu.getNombreEmpleado());
